...
/**
 * Perform an action on [AutoCompleteTextView] dismiss events, in a new [CoroutineScope].
 *
 * *Warning:* The created actor uses [AutoCompleteTextView.setOnDismissListener]. Only one actor can
 * be used at a time.
 *
...
/**
 * Create a channel that emits [AutoCompleteTextView] dismiss events.
 *
...
/**
 * Create a flow that emits [AutoCompleteTextView] dismiss events.
 *
