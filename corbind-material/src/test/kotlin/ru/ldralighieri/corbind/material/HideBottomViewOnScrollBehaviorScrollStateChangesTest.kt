...
class HideBottomViewOnScrollBehaviorScrollStateChangesTest {
    ...
    @Suppress("DEPRECATION")
    private class TrackingHideBottomBehavior : HideBottomViewOnScrollBehavior<View>() {
