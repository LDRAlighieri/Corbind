...
class NavigationViewItemSelectionsTest {
    private fun fixture() = NavigationViewSelectionsFixture(materialTestContext())
...
private class NavigationViewSelectionsFixture(context: Context) : InitialEmittingFlowFixture {
    private val view = TrackingSelectionNavigationView(context).apply {
        menu.add(1, FIRST_MATERIAL_ITEM, Menu.NONE, "First")
        menu.add(1, SECOND_MATERIAL_ITEM, Menu.NONE, "Second")
        menu.setGroupCheckable(1, true, true)
        setCheckedItem(FIRST_MATERIAL_ITEM)
        resetTracking()
    }
...
private class TrackingSelectionNavigationView(context: Context) : NavigationView(context) {
    var registrationCount = 0
        private set
    var cleanupCount = 0
        private set
    var itemSelectedListener: OnNavigationItemSelectedListener? = null
        private set
