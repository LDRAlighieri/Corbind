...
class MaterialTimePickerCancelsTest {
    ...
    private fun MaterialTimePicker.listeners(): Set<DialogInterface.OnCancelListener> {
        val field = javaClass.getDeclaredField("cancelListeners")
