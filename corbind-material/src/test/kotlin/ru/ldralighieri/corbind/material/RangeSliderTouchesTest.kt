...
class RangeSliderTouchesTest {
    ...
    private fun RangeSlider.listeners(): List<RangeSlider.OnSliderTouchListener> {
        val field = requireNotNull(javaClass.superclass).getDeclaredField("touchListeners")
        field.isAccessible = true
        return field.get(this) as List<RangeSlider.OnSliderTouchListener>
    }
}
