...
class MaterialDatePickerNegativeClicksTest {
    ...
    private fun MaterialDatePicker<Long>.listeners(): Set<View.OnClickListener> {
        val field = javaClass.getDeclaredField("onNegativeButtonClickListeners")
