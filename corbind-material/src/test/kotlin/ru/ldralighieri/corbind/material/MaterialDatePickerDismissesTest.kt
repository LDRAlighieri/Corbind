...
class MaterialDatePickerDismissesTest {
    ...
    private fun MaterialDatePicker<Long>.listeners(): Set<DialogInterface.OnDismissListener> {
        val field = javaClass.getDeclaredField("onDismissListeners")
